...
🛠️ Stack
<!-- **Linguagem:** Python
- **Foco:** Telemetria (leitura de sensores de nível/pressão) + Machine Learning para diagnóstico preditivo
- **Área de aplicação:** Gestão de fármacos gasosos em unidades de saúde (SUS)reencha aqui as tecnologias que você está usando ou pretende usar (Python? Node? algum modelo de ML específico?) --> 
👤 Autor
